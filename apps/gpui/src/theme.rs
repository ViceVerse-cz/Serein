...
impl Icon {
	fn path(self) -> &'static str {
		match self {
			...
			Self::Forum => "icons/chat-centered-text.svg",
			...
			Self::Lock => "icons/lock-simple.svg",
			Self::More => "icons/dots-three.svg",
			Self::Thread => "icons/thread.svg",
			Self::Calendar => "icons/calendar-blank.svg",
			Self::Headphones => "icons/headphones.svg",
			Self::Microphone => "icons/microphone.svg",
			Self::UserPlus => "icons/user-plus.svg",
			Self::Reload => "icons/arrow-clockwise.svg",
			Self::ArrowUp => "icons/arrow-up.svg",
			Self::Gif => "icons/gif.svg",
			Self::GameController => "icons/game-controller.svg",
			Self::Threads => "icons/chats.svg",
			...
			Self::ShieldWarning => "icons/shield-warning.svg",
			Self::ScreenShare => "icons/monitor-arrow-up.svg",
			Self::Crown => "icons/crown.svg",
			Self::ShoppingCart => "icons/shopping-cart-simple.svg",
			Self::ChartBar => "icons/chart-bar.svg",
			Self::Help => "icons/question.svg",
			Self::StarFill => "icons/star-fill.svg",
			Self::Fire => "icons/fire.svg",
